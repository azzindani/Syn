...
- Modern: Office Scripts (TS) callable via Graph/Power Automate REST from Syn.
...
- Takeaway: standalone works, but no shared desktop session + no external models — the gap Syn fills.
