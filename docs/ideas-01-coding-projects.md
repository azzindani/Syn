...
3. Dead Man's Switch Vault: Shamir + age encryption, proof-of-life cron, release to contacts.
4. Abandonware Doctor: find dead 10k-star repos, Docker build, fix deps, open PR. Go/Python+Docker+GitHub+SBOM.
5. Low-Bandwidth Proxy: crush any site to <50KB text, dithered images. Go+headless Chromium.
6. Binary Autopsy Studio: drop exe/pdf/docx/db/ttf -> hex+structure+entropy. Rust+WASM+Kaitai.
