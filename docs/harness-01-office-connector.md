# Harness 01 — MS Office Connector
...
- Modern: Office Scripts (TS) callable via Graph/Power Automate REST from harness.
...
- Takeaway: standalone works, but no shared desktop session + no external models — the gap this harness fills.
